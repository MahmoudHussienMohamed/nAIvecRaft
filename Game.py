...
# Instantiation order = draw order (later = on top)
waves = Wave()       # bottom: ocean surface, slow
land = Land()        # mid:    islands on the ocean, slow
clouds = Cloud()     # top:    clouds above everything, fast
